...
/decl/hierarchy/outfit/job/unsc/marine
	name = "Marine (e2)"
...
/decl/hierarchy/outfit/job/unsc/marine/e3
	name = "Marine (e3)"
	starting_accessories = list(\
		/obj/item/clothing/accessory/rank/marine/enlisted/e3,\
		/obj/item/clothing/accessory/badge/tags)

/decl/hierarchy/outfit/job/unsc/marine/e4
	name = "Marine (e4)"
	starting_accessories = list(\
...
/decl/hierarchy/outfit/job/unsc/marine/e8
	name = "Marine Master Sergeant (e8)"
	starting_accessories = list(\
		/obj/item/clothing/accessory/rank/marine/enlisted/e8,\
		/obj/item/clothing/accessory/badge/tags)

/decl/hierarchy/outfit/job/unsc/marine/e9
	name = "Marine Master Gunnery Sergeant (e9)"
	starting_accessories = list(\
...
/decl/hierarchy/outfit/job/unsc/marine/wo
	name = "Marine Gunnery Sergeant (WO)"
	starting_accessories = list(\
		/obj/item/clothing/accessory/rank/fleet/officer/wo,\
		/obj/item/clothing/accessory/badge/tags)

/decl/hierarchy/outfit/job/unsc/marine/wo2
	name = "Marine Gunnery Sergeant (WO-2)"
	starting_accessories = list(\
